...
@Composable
fun Reminders(drawer: DrawerState) {
        ...
        Box ( modifier = Modifier
            ...
            Column(
                ...
                Icon(modifier = Modifier
                    .padding(16.dp)
                    .size(128.dp), painter = painterResource(id = R.drawable.ic_reminder_24), contentDescription = "")
                Text(text = "Notes with upcoming reminders appear here")
            }
        }
    }
}